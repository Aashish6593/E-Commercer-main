...
if (isset($_POST['submit'])) {
    ...
    if (empty($errors)) {
        $insert_product = mysqli_query($conn, "INSERT INTO product(name,price,image) VALUES('$product_Name','$product_Price','$file_name')");
        if ($insert_product == 1) {
    ...
    <div class="form-container">
        ...
        if ($productSaved) {
            ...
            <a href="display.php" class="link-to-product-details">
                Click to see the saved product details
            </a>
            <?php
        }
        ?>
